...
would a perfectly steady ground with the craft set down beside it, off by a rounding error shared by
the placement and by the **On rails** reading, where it would cancel out. Both fill the same table.
